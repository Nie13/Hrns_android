...
public class actByteStream extends BaseCommActivity{
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        //MenuItem miClearHistory = menu.add(0, MENU_CLEAR_CMD_HISTORY, 0, getString(R.string.menu_clear_cmd_history));
        //miClearHistory.setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER); //一直隐藏
        //MenuItem miHelper = menu.add(0, MENU_HELPER, 0, getString(R.string.menu_helper));
